...
class S3RArgumentParser(Tap):
    ...
    preprocessed: bool = False  # use preprocessed data
    ...
    resume2: Optional[str] = None  # trained checkpoint path. use when inference
    resume3: Optional[str] = None  # trained checkpoint path. use when inference
    resume4: Optional[str] = None  # trained checkpoint path. use when inference
    resume5: Optional[str] = None  # trained checkpoint path. use when inference
